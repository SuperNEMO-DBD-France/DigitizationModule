  ...
  namespace digitization {
    ...
    public :
      ...
      enum tp_electronic_ID_index {
			...
			static const uint32_t GEIGER_CATEGORY_TYPE             = 1210;
			...
			static const uint32_t TRACKER_CONTROL_BOARD_TYPE     = 666;
			static const uint32_t CALORIMETER_CONTROL_BOARD_TYPE = 666;

			static const uint32_t CALO_RACK_ID    = 3;
			static const uint32_t TRIGGER_RACK_ID = 3;
			static const uint32_t GEIGER_RACK_ID  = 5;
			...
			static const uint32_t TRIGGER_BOARD_ID = 20;
