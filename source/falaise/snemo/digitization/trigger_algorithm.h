...
namespace snemo {
  ...
  namespace digitization {
    ...
    public :
      ...
      bool has_L2_coincidence_gate_size() const;

      /// Set the L2 decision coincidence gate size
      void set_L2_coincidence_gate_size(unsigned int L2_decision_coincidence_gate_size_);

      /// Set the L2 decision coincidence gate size
      unsigned int get_L2_coincidence_gate_size();
    ...
    protected :
      ...
      void _process_calo_tracker_coincidence(const std::pair<trigger_structures::coincidence_calo_record,
    ...
    private :
      ...
      unsigned int _L2_coincidence_gate_size_; //!< Size of the L2 decision coincidence gate (typically 5 x 1600 ns)
      ...
      uint64_t _trigger_id_; //!< Trigger ID counter attributed to a given decision
      ...
      std::vector<trigger_structures::L2_coincidence_gate> _L2_coincidence_gate_records_; //!< Collection of L2 coincidence  gates which the calo / tracker coincidence CAN happen
      ...
      std::vector<trigger_structures::L2_decision>      _L2_decision_records_; //!< Collection of L2 decision
      std::vector<trigger_structures::L2_decision_gate> _L2_decision_gate_records_; //!< Collection of L2 gates which launch the readout
